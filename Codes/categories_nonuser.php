        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                foreach ($categories as $category) {
                    ...
                    echo "<li><a href='p_categories_nonuser.php?p_category_id=" . htmlspecialchars($category['p_category_id'], ENT_QUOTES, 'UTF-8') . "' class='$isActive'>" . htmlspecialchars($category['category_name'], ENT_QUOTES, 'UTF-8') . "</a></li>";
                }
                ?>
            </ul>
        </div>
            ...
            <?php if (!empty($products)) { ?>
                <div class="products">
                    ...
                    foreach ($products as $product) {
                        ...
                        $productUrl = "product_details_nonuser.php?product_name=$productName&worker_id=$workerId";
