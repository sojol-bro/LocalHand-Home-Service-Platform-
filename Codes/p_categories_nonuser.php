            ...
            <?php if (!empty($products)) { ?>
                <div class="products">
                    <?php foreach ($products as $product) { ?>
                        <a href="product_details_nonuser.php?product_name=<?php echo urlencode($product['product_name']); ?>&worker_id=<?php echo urlencode($product['worker_id']); ?>" class="product-link">
    <div class="product">
